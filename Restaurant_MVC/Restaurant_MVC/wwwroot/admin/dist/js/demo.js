...
//var currentFilterValue = ""; // Lấy giá trị của currentFilter từ nguồn nào đó
//var pageValue = "1"; // Lấy giá trị của page từ nguồn nào đó
//var page1Value = "1"; // Lấy giá trị của page1 từ nguồn nào đó

//var apiUrl = "/api/Reservation";
////var queryString = `?currentFilter=${currentFilterValue}&page=${pageValue}&page1=${page1Value}`;
//var queryString = `?page=${pageValue}&page1=${page1Value}`;
...
//    // Bắt sự kiện click phân trang hoặc tìm kiếm
//    $(document).on("click", ".pagination a, #search-button", function (event) {
//        event.preventDefault();
//        var url = $(this).attr("href");
//        var containerId = "ajax-container";
...
// Xử lý sự kiện khi ô master checkbox được thay đổi
masterCheckbox.addEventListener('change', function () {
    const isChecked = this.checked; // Lấy trạng thái "tít" của ô master checkbox

    // Thiết lập trạng thái "tít" cho các ô child checkbox dựa trên ô master checkbox
    childCheckboxes.forEach(function (checkbox) {
        checkbox.checked = isChecked;
    });
});

// Xử lý sự kiện khi một ô child checkbox được thay đổi
childCheckboxes.forEach(function (checkbox) {
    checkbox.addEventListener('change', function () {
        // Nếu có bất kỳ ô child checkbox nào không được "tít", hãy bỏ "tít" khỏi ô master checkbox
        if (!this.checked) {
